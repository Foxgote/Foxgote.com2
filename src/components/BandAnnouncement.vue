...
<style scoped>
aside.band-announcement{font-family:var(--font-body);background:linear-gradient(160deg,rgba(18,14,10,.96),rgba(8,8,10,.98));border-color:rgba(255,220,180,.22)}
.band-announcement h2{font-family:var(--font-display);font-weight:620;letter-spacing:0}
.band-announcement a.apply{border:1px solid rgba(255,220,180,.52);border-radius:2px;background:rgba(10,11,13,.54);color:rgba(255,235,208,.94);font-size:.7rem;font-weight:500;letter-spacing:.1em;text-transform:uppercase}
